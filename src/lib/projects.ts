...
export const projects: Project[] = [
  {
    ...
    technique: "Cold Connections, Metalworking, Precision Piercing, Soldering, Chemical Patination, Wire Wrapping, UV Resin",
    ...
    final: "The completed piece is a wearable narrative — an eye brooch with custom wire eyelashes, blood-red bead tears, and a UV-resin-sealed iris. The hinge and catch mechanism were hand-fabricated, allowing the piece to function as a proper, wearable brooch. Completed as my final project for Introduction to Jewelry at SCAD, 2026.",
  },
  {
    slug: "draconis",
    title: "Draconis",
    ...
    technique: "Fabrication, Sheet Metal Work, Soldering, Wireworking",
    ...
    thumbnail: "/earrings/final-1.jpg",
    banner: "/earrings/final-2.jpg",
    ...
    images: [
      ...
      { src: "/earrings/sketches.png", caption: "Sketches — four iterations of the ear cuff form" },
      { src: "/earrings/front.png", caption: "Prototype — front view, brass ear cuffs with moonstone drops" },
      { src: "/earrings/back.png", caption: "Prototype — back view showing structural detail and moonstone bezel" },
      { src: "/earrings/final-1.jpg", caption: "Final Product — Draconis worn, close-up detail shot" },
      { src: "/earrings/final-2.jpg", caption: "Final Product — Draconis in full, Savannah editorial" },
    ],
    ...
    final: "Draconis — brass ear cuffs with moonstone drops, shot on location in Savannah. Available to commission via the contact page.",
  },
];
