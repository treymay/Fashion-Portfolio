...
import digitizingSummary from "../../../Digitizing Design Ideas/Digi.png";
      ...
      <div className="px-6 md:px-12 lg:px-20 max-w-6xl mx-auto">
        <ScrollReveal>
          ...
          <p className="font-sans text-ink/70 dark:text-white/70 mt-4 text-lg max-w-3xl">
            An assortment of miscellaneous projects I have worked on.
          </p>
        </ScrollReveal>

        <div className="mt-12 grid grid-cols-1 gap-8">
          <ScrollReveal>
            <Link href="/archive/digitizing-design-ideas" className="block group">
              <motion.article
                whileHover={{ y: -3 }}
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12">
                  <div className="relative aspect-[16/10] lg:aspect-auto lg:h-full lg:col-span-7">
                    <Image
                      src={digitizingSummary}
                      alt="IDUS 231 digitizing design ideas class collage"
                      fill
                      priority
                  ...
                  <div className="lg:col-span-5 p-6 md:p-8 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="font-sans text-ink/75 dark:text-white/75 mt-4 leading-relaxed">
                        A collection of assignment-based 3D models from IDUS 231: Digitizing Design Ideas, showcasing object studies, rendering, and form development.
                      </p>
                    </div>
                    <div className="mt-6">
          ...
          <ScrollReveal delay={0.08}>
            <Link href="/archive/flo-state" className="block group">
              <motion.article
                whileHover={{ y: -3 }}
                className="border border-ink/15 dark:border-white/15 rounded-sm overflow-hidden bg-ink/5 dark:bg-white/5"
              >
